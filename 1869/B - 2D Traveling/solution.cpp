...
void solve() {
    ...
    ll ans=(abs(arr[a].first-arr[b].first)+abs(arr[a].second-arr[b].second));
    ll mini_a=1e18;
    ll mini_b=1e18;
    for(ll i=1;i<=k;i++){
        ll temp1=0;
        ll temp2=0;
        temp1=(abs(arr[a].first-arr[i].first)+abs(arr[a].second-arr[i].second));
        temp2=(abs(arr[b].first-arr[i].first)+abs(arr[b].second-arr[i].second));
        mini_a=min(mini_a,temp1);
        mini_b=min(mini_b,temp2);
